                    ...
                    <div class="col-lg-12">
                        <div class="block">
                            ...
                            <div class="block-body">
                                ...
                                <?php endif; ?>
                                <form action="<?php echo e(url('edit_kamar', $data->id)); ?>" method="Post"
                                    enctype="multipart/form-data" class="form-horizontal">
                                    <?php echo csrf_field(); ?>
                                    <div class="form-group row">
                                        <label class="col-sm-3 form-control-label">Nama Kamar</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="kamar" value="<?php echo e($data->nama_kamar); ?>"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="type" class="form-control mb-3 mb-3">
                                                <option selected value="<?php echo e($data->type_kamar); ?>"><?php echo e($data->type_kamar); ?>
...
<?php /**PATH C:\xampp\htdocs\si_hotell\resources\views/admin/update_kamar.blade.php ENDPATH**/ ?>